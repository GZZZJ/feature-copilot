...
-- table_name: light_repay_behaviour_aggregate_to_uid_tmp
-- node_id: n_6922256996381753344
-- task_name: dwa_risk_dz_model_30light_cross_heavy_inner_behaviour_df
-- owner_name: 牛莲泽
-- source_json: goal/dp_table_logic/dwa_risk_internal_upstream/light_repay_behaviour_aggregate_to_uid_tmp.json
