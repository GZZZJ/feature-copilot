...
-- table_name: dwa_risk_dz_model_final_7fst_9all_10cur_11lst_orders_info_jqh_df
-- node_id: n_6398954504545107968
-- task_name: dwa_risk_dz_model_final_7fst_9all_10cur_11lst_orders_info_jqh_df
-- owner_name: 王博韬
-- source_json: goal/dp_table_logic/dwa_risk_first_upstream/dwa_risk_dz_model_final_7fst_9all_10cur_11lst_orders_info_jqh_df.json
-- source_json_sha256: 58e6b5c2b3c4dd2662d742d925240305b6a8245b88099851f6f9a3b2a2d543eb
-- upstream_table: dwa_risk.dwa_risk_f_heavy_order_info_detail_jqh
-- upstream_table: dwa_risk.dwa_risk_7suc_weighted_stg_num_tmp_jqh_bizdate
-- upstream_table: dwa_risk.dwa_risk_dz_model_final_7fst_9all_10cur_11lst_orders_info_apply_tmp1_jqh_bizdate
-- upstream_table: dwa_risk.dwa_risk_dz_model_final_7fst_9all_10cur_11lst_orders_info_succ_tmp2_jqh_bizdate
-- upstream_table: dwa_risk.dwa_risk_dz_model_final_7fst_9all_10cur_11lst_orders_info_succ_tmp3_jqh_bizdate
-- upstream_table: dwa_risk.dwa_risk_f_dz_model_data_base_jqh_df
-- upstream_table: dwa_risk.dwa_risk_7fst_orders_info_tmp_jqh_bizdate
...
--创建者: 王博韬
--创建日期: 2024-11-25 11:26:13
--修改日期	修改人	修改内容
--yyyymmdd	name	comment
--********************************************************************--
create table if not exists ${dwa_risk}.dwa_risk_dz_model_final_7fst_9all_10cur_11lst_orders_info_jqh_df
(
	`uid` STRING COMMENT '用户ID',
	`mdl_dte` DATE,
	`ord_apl_sum_prc_amt_360_day` DECIMAL(28, 6) COMMENT '所有订单结清前12个月内发起动支订单的动支总金额总额',
	`ord_apl_max_prc_amt_360_day` DECIMAL(18, 6) COMMENT '所有订单结清前12个月内发起动支订单的最大动支总金额总额',
	`ord_apl_min_prc_amt_360_day` DECIMAL(18, 6) COMMENT '所有订单结清前12个月内发起动支订单的最小动支总金额总额',
	`ord_apl_cnt_360_day` BIGINT COMMENT '所有订单结清前12个月内发起动支订单的次数',
	`ord_apl_fal_cnt_360_day` BIGINT COMMENT '所有订单结清前12个月内发起动支订单的失败次数',
	`ord_apl_sum_prc_amt_360_day_00_03` DECIMAL(28, 6) COMMENT '所有订单结清前12个月内发起动支订单的动支总金额总额（0点到3点）',
	`ord_apl_cnt_360_day_00_03` BIGINT COMMENT '所有订单结清前12个月内发起动支订单的次数（0点到3点）',
	`ord_apl_sum_prc_amt_360_day_04_06` DECIMAL(28, 6) COMMENT '所有订单结清前12个月内发起动支订单的动支总金额总额（4点到6点）',
	`ord_apl_cnt_360_day_04_06` BIGINT COMMENT '所有订单结清前12个月内发起动支订单的次数（4点到6点）',
	`ord_apl_sum_prc_amt_360_day_07_12` DECIMAL(28, 6) COMMENT '所有订单结清前12个月内发起动支订单的动支总金额总额（7点到12点）',
	`ord_apl_cnt_360_day_07_12` BIGINT COMMENT '所有订单结清前12个月内发起动支订单的次数（7点到12点）',
	`ord_apl_sum_prc_amt_360_day_13_18` DECIMAL(28, 6) COMMENT '所有订单结清前12个月内发起动支订单的动支总金额总额（13点到18点）',
	`ord_apl_cnt_360_day_13_18` BIGINT COMMENT '所有订单结清前12个月内发起动支订单的次数（13点到18点）',
	`ord_apl_sum_prc_amt_360_day_19_23` DECIMAL(28, 6) COMMENT '所有订单结清前12个月内发起动支订单的动支总金额总额（19点到23点）',
	`ord_apl_cnt_360_day_19_23` BIGINT COMMENT '所有订单结清前12个月内发起动支订单的次数（19点到23点）',
	`his_360_day_bt_apl_ord_cnt` BIGINT COMMENT '所有订单结清前12个月内历史BT订单总数',
	`his_360_day_csh_apl_ord_cnt` BIGINT COMMENT '所有订单结清前12个月内历史CASH订单总数',
	`his_360_day_prc_amt_1_000_flg_apl_ord_cnt` BIGINT COMMENT '所有订单结清前12个月内历史借款金额超1000（含）借款次数',
	`his_360_day_prc_amt_3_000_flg_apl_ord_cnt` BIGINT COMMENT '所有订单结清前12个月内历史借款金额超3000（含）借款次数',
	`his_360_day_prc_amt_5_000_flg_apl_ord_cnt` BIGINT COMMENT '所有订单结清前12个月内历史借款金额超5000（含）借款次数',
	`his_360_day_prc_amt_10_000_flg_apl_ord_cnt` BIGINT COMMENT '所有订单结清前12个月内历史借款金额超10000（含）借款次数',
	`ord_apl_suc_sum_prc_amt_360_day` DECIMAL(28, 6) COMMENT '所有订单结清前12个月内成功动支订单的动支总金额',
	`ord_apl_suc_max_prc_amt_360_day` DECIMAL(18, 6) COMMENT '所有订单结清前12个月内成功动支订单的最大动支总金额',
	`ord_apl_suc_min_prc_amt_360_day` DECIMAL(18, 6) COMMENT '所有订单结清前12个月内成功动支订单的最小动支总金额',
	`pst_ord_apl_suc_sum_prc_amt_360_day` DECIMAL(28, 6) COMMENT '所有订单结清前12个月内成功动支订单的动支总金额（复借订单）',
	`pst_ord_apl_suc_max_prc_amt_360_day` DECIMAL(18, 6) COMMENT '所有订单结清前12个月内成功动支订单的最大动支总金额（复借订单）',
	`pst_ord_apl_suc_min_prc_amt_360_day` DECIMAL(18, 6) COMMENT '所有订单结清前12个月内成功动支订单的最小动支总金额（复借订单）',
	`ord_apl_suc_cnt_360_day` BIGINT COMMENT '所有订单结清前12个月内成功动支订单的次数',
	`ord_apl_suc_6_cnt_360_day` BIGINT COMMENT '所有订单结清前12个月内成功动支订单的次数（6期订单）',
	`ord_apl_suc_12_cnt_360_day` BIGINT COMMENT '所有订单结清前12个月内成功动支订单的次数（12期订单）',
	`pst_ord_apl_suc_cnt_360_day` BIGINT COMMENT '所有订单结清前12个月内成功动支订单的次数（复借订单）',
	`ord_apl_suc_sum_prc_amt_360_day_00_03` DECIMAL(28, 6) COMMENT '所有订单结清前12个月内成功动支订单的动支总金额总额（0点到3点）',
	`ord_apl_suc_cnt_360_day_00_03` BIGINT COMMENT '所有订单结清前12个月内成功动支订单的次数（0点到3点）',
	`ord_apl_suc_sum_prc_amt_360_day_04_06` DECIMAL(28, 6) COMMENT '所有订单结清前12个月内成功动支订单的动支总金额总额（4点到6点）',
	`ord_apl_suc_cnt_360_day_04_06` BIGINT COMMENT '所有订单结清前12个月内成功动支订单的次数（4点到6点）',
	`ord_apl_suc_sum_prc_amt_360_day_07_12` DECIMAL(28, 6) COMMENT '所有订单结清前12个月内成功动支订单的动支总金额总额（7点到12点）',
	`ord_apl_suc_cnt_360_day_07_12` BIGINT COMMENT '所有订单结清前12个月内成功动支订单的次数（7点到12点）',
	`ord_apl_suc_sum_prc_amt_360_day_13_18` DECIMAL(28, 6) COMMENT '所有订单结清前12个月内成功动支订单的动支总金额总额（13点到18点）',
	`ord_apl_suc_cnt_360_day_13_18` BIGINT COMMENT '所有订单结清前12个月内成功动支订单的次数（13点到18点）',
	`ord_apl_suc_sum_prc_amt_360_day_19_23` DECIMAL(28, 6) COMMENT '所有订单结清前12个月内成功动支订单的动支总金额总额（19点到23点）',
	`ord_apl_suc_cnt_360_day_19_23` BIGINT COMMENT '所有订单结清前12个月内成功动支订单的次数（19点到23点）',
	`ord_apl_suc_sum_stg_num_360_day` BIGINT COMMENT '所有订单结清前12个月内成功动支订单的总分期数',
	`ord_apl_suc_max_stg_num_360_day` INT COMMENT '所有订单结清前12个月内成功动支订单的最大分期数',
	`ord_apl_suc_min_stg_num_360_day` INT COMMENT '所有订单结清前12个月内成功动支订单的最小分期数',
	`pst_ord_apl_suc_sum_stg_num_360_day` BIGINT COMMENT '所有订单结清前12个月内成功动支订单的总分期数（复借订单）',
	`ord_apl_suc_weighted_stg_num_360_day` DECIMAL(38, 9) COMMENT '所有订单结清前12个月内成功动支订单的加权分期数',
	`bsy_typ_suc_cnt_360_day` BIGINT COMMENT '所有订单结清前12个月内成功动支订单的业务类型数',
	`if_not_bt_csh_suc_360_day` INT COMMENT '所有订单结清前12个月内是否借过bt_cash产品',
	`his_360_day_bt_suc_ord_cnt` BIGINT COMMENT '所有订单结清前12个月内历史BT订单总数（不含失败）',
	`his_360_day_csh_suc_ord_cnt` BIGINT COMMENT '所有订单结清前12个月内历史CASH订单总数（不含失败）',
	`his_360_day_prc_amt_1_000_flg_suc_ord_cnt` BIGINT COMMENT '所有订单结清前12个月内历史借款金额超1000（含）借款次数（不含失败）',
	`his_360_day_prc_amt_3_000_flg_suc_ord_cnt` BIGINT COMMENT '所有订单结清前12个月内历史借款金额超3000（含）借款次数（不含失败）',
	`his_360_day_prc_amt_5_000_flg_suc_ord_cnt` BIGINT COMMENT '所有订单结清前12个月内历史借款金额超5000（含）借款次数（不含失败）',
	`his_360_day_prc_amt_10_000_flg_suc_ord_cnt` BIGINT COMMENT '所有订单结清前12个月内历史借款金额超10000（含）借款次数（不含失败）',
	`ord_apl_avg_prc_amt_360_day` DECIMAL(38, 16) COMMENT '所有订单结清前12个月内发起动支订单的动支总金额_单次平均',
	`ord_apl_avg_prc_amt_360_day_per_mth` DECIMAL(31, 9) COMMENT '所有订单结清前12个月内发起动支订单的动支总金额_单月平均',
	`his_360_day_bt_apl_ord_cnt_his_rto` DOUBLE COMMENT '所有订单结清前12个月内历史BT订单总数/总订单数',
	`his_360_day_csh_apl_ord_cnt_his_rto` DOUBLE COMMENT '所有订单结清前12个月内历史CASH订单总数/总订单数',
	`his_360_day_bt_apl_ord_cnt_csh_rto` DOUBLE COMMENT '所有订单结清前12个月内历史BT订单总数/CASH订单数',
	`ord_apl_suc_avg_prc_amt_360_day` DECIMAL(38, 16) COMMENT '所有订单结清前12个月内成功动支订单的动支总金额_单次平均',
	`ord_apl_suc_avg_prc_amt_360_day_per_mth` DECIMAL(31, 9) COMMENT '所有订单结清前12个月内成功动支订单的动支总金额_单月平均',
	`ord_apl_suc_avg_stg_num_360_day` DOUBLE COMMENT '所有订单结清前12个月内成功动支订单的分期数_单次平均',
	`ord_apl_suc_6_cnt_360_day_rto` DOUBLE COMMENT '所有订单结清前12个月内成功动支订单的次数（6期订单）_占比',
	`ord_apl_suc_12_cnt_360_day_rto` DOUBLE COMMENT '所有订单结清前12个月内成功动支订单的次数（12期订单）_占比',
	`pst_ord_apl_suc_avg_prc_amt_360_day` DECIMAL(38, 16) COMMENT '所有订单结清前12个月内成功动支订单的动支总金额（复借订单）_单次平均',
	`pst_ord_apl_suc_avg_prc_amt_360_day_per_mth` DECIMAL(31, 9) COMMENT '所有订单结清前12个月内成功动支订单的动支总金额（复借订单）_单月平均',
	`pst_ord_apl_suc_avg_stg_num_360_day` DOUBLE COMMENT '所有订单结清前12个月内成功动支订单的分期数（复借订单）_单次平均',
	`his_360_day_bt_suc_ord_cnt_his_rto` DOUBLE COMMENT '所有订单结清前12个月内历史BT订单总数/总订单数（不含失败）',
        `his_360_day_csh_suc_ord_cnt_his_rto` DOUBLE COMMENT '所有订单结清前12个月内历史CASH订单总数/总订单数（不含失败）',
	`his_360_day_bt_suc_ord_cnt_csh_rto` DOUBLE COMMENT '所有订单结清前12个月内历史BT订单总数/CASH订单数（不含失败）'
)
COMMENT '结清户交易信息表'
PARTITIONED BY (
...
drop table if exists ${dwa_risk}.dwa_risk_dz_model_final_7fst_9all_10cur_11lst_orders_info_apply_tmp1_jqh_${bizdate};
create table ${dwa_risk}.dwa_risk_dz_model_final_7fst_9all_10cur_11lst_orders_info_apply_tmp1_jqh_${bizdate} as 
select uid
        ,mdl_dte
-- features range start --
        ...
        ,count(case when ddf_day_flag=1 then dtl_ord_no else null end) as his_apl_ord_cnt
...
from   (select *
        ...
        from ${dwa_risk}.dwa_risk_f_heavy_order_info_detail_jqh
        where ds='${bizdate}'
        )main
group by uid
        ,mdl_dte
...
drop table if exists ${dwa_risk}.dwa_risk_dz_model_final_7fst_9all_10cur_11lst_orders_info_succ_tmp2_jqh_${bizdate};
create table ${dwa_risk}.dwa_risk_dz_model_final_7fst_9all_10cur_11lst_orders_info_succ_tmp2_jqh_${bizdate} as 
select uid
        ,mdl_dte
-- features range start --
...
drop table if exists ${dwa_risk}.dwa_risk_dz_model_final_7fst_9all_10cur_11lst_orders_info_succ_tmp3_jqh_${bizdate};
create table ${dwa_risk}.dwa_risk_dz_model_final_7fst_9all_10cur_11lst_orders_info_succ_tmp3_jqh_${bizdate} as 
select uid
        ,mdl_dte
-- features range start --
        ...
        ,count(case when ddf_day_flag=1  then dtl_ord_no else null end) as his_suc_ord_cnt
...
drop table if exists ${dwa_risk}.dwa_risk_7suc_weighted_stg_num_tmp_jqh_${bizdate};
create table ${dwa_risk}.dwa_risk_7suc_weighted_stg_num_tmp_jqh_${bizdate} as 
select main.uid
        ,main.mdl_dte
-- features range start --
        --加权分期数
...
drop table if exists ${dwa_risk}.dwa_risk_7fst_orders_info_tmp_jqh_${bizdate};
create table ${dwa_risk}.dwa_risk_7fst_orders_info_tmp_jqh_${bizdate} as 
...
from (select uid
            ...
            ,fst_ord_prc_amt
    -- features range end --
    from ${dwa_risk}.dwa_risk_dz_model_final_7fst_9all_10cur_11lst_orders_info_succ_tmp2_jqh_${bizdate}
    )order_succ1
--/*2、注册环节*/
--/*4、申请环节*/
left join
...
insert overwrite table ${dwa_risk}.dwa_risk_dz_model_final_7fst_9all_10cur_11lst_orders_info_jqh_df partition(ds='${bizdate}')
select 
        main.uid,
        main.mdl_dte,
        
        main.ord_apl_sum_prc_amt_360_day,
        main.ord_apl_max_prc_amt_360_day,
        main.ord_apl_min_prc_amt_360_day,
        main.ord_apl_cnt_360_day,
        main.ord_apl_fal_cnt_360_day,
        main.ord_apl_sum_prc_amt_360_day_00_03,
        main.ord_apl_cnt_360_day_00_03,
        main.ord_apl_sum_prc_amt_360_day_04_06,
        main.ord_apl_cnt_360_day_04_06,
        main.ord_apl_sum_prc_amt_360_day_07_12,
        main.ord_apl_cnt_360_day_07_12,
        main.ord_apl_sum_prc_amt_360_day_13_18,
        main.ord_apl_cnt_360_day_13_18,
        main.ord_apl_sum_prc_amt_360_day_19_23,
        main.ord_apl_cnt_360_day_19_23,
        main.his_360_day_bt_apl_ord_cnt,
        main.his_360_day_csh_apl_ord_cnt,
        main.his_360_day_prc_amt_1_000_flg_apl_ord_cnt,
        main.his_360_day_prc_amt_3_000_flg_apl_ord_cnt,
        main.his_360_day_prc_amt_5_000_flg_apl_ord_cnt,
        main.his_360_day_prc_amt_10_000_flg_apl_ord_cnt,
        main.ord_apl_suc_sum_prc_amt_360_day,
        main.ord_apl_suc_max_prc_amt_360_day,
        main.ord_apl_suc_min_prc_amt_360_day,
        main.pst_ord_apl_suc_sum_prc_amt_360_day,
        main.pst_ord_apl_suc_max_prc_amt_360_day,
        main.pst_ord_apl_suc_min_prc_amt_360_day,
        main.ord_apl_suc_cnt_360_day,
        main.ord_apl_suc_6_cnt_360_day,
        main.ord_apl_suc_12_cnt_360_day,
        main.pst_ord_apl_suc_cnt_360_day,
        main.ord_apl_suc_sum_prc_amt_360_day_00_03,
        main.ord_apl_suc_cnt_360_day_00_03,
        main.ord_apl_suc_sum_prc_amt_360_day_04_06,
        main.ord_apl_suc_cnt_360_day_04_06,
        main.ord_apl_suc_sum_prc_amt_360_day_07_12,
        main.ord_apl_suc_cnt_360_day_07_12,
        main.ord_apl_suc_sum_prc_amt_360_day_13_18,
        main.ord_apl_suc_cnt_360_day_13_18,
        main.ord_apl_suc_sum_prc_amt_360_day_19_23,
        main.ord_apl_suc_cnt_360_day_19_23,
        main.ord_apl_suc_sum_stg_num_360_day,
        main.ord_apl_suc_max_stg_num_360_day,
        main.ord_apl_suc_min_stg_num_360_day,
        main.pst_ord_apl_suc_sum_stg_num_360_day,
        main.ord_apl_suc_weighted_stg_num_360_day,
        main.bsy_typ_suc_cnt_360_day,
        main.if_not_bt_csh_suc_360_day,
        main.his_360_day_bt_suc_ord_cnt,
        main.his_360_day_csh_suc_ord_cnt,
        main.his_360_day_prc_amt_1_000_flg_suc_ord_cnt,
        main.his_360_day_prc_amt_3_000_flg_suc_ord_cnt,
        main.his_360_day_prc_amt_5_000_flg_suc_ord_cnt,
        main.his_360_day_prc_amt_10_000_flg_suc_ord_cnt
-- features range start --
...
-- features range end --
        ...
        from (select uid
                  ,mdl_dte
            from ${dwa_risk}.dwa_risk_f_dz_model_data_base_jqh_df
            where ds='${bizdate}'
            )model_data  --建模样本
        left join ${dwa_risk}.dwa_risk_dz_model_final_7fst_9all_10cur_11lst_orders_info_apply_tmp1_jqh_${bizdate} order_apply on model_data.uid=order_apply.uid
        left join ${dwa_risk}.dwa_risk_dz_model_final_7fst_9all_10cur_11lst_orders_info_succ_tmp2_jqh_${bizdate} order_succ1 on model_data.uid=order_succ1.uid
        left join ${dwa_risk}.dwa_risk_dz_model_final_7fst_9all_10cur_11lst_orders_info_succ_tmp3_jqh_${bizdate} order_succ2 on model_data.uid=order_succ2.uid
        left join ${dwa_risk}.dwa_risk_7fst_orders_info_tmp_jqh_${bizdate} fst_order on model_data.uid=fst_order.uid
        left join ${dwa_risk}.dwa_risk_7suc_weighted_stg_num_tmp_jqh_${bizdate} weighted_stg_num on model_data.uid=weighted_stg_num.uid
        )main;
