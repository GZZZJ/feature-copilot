...
-- table_name: pdm_risk_dz_br_horizontal_two_report_rct_mon_two_coalesce
-- node_id: n_7014197334062661632
-- task_name: pdm_risk.pdm_risk_dz_br_max_two_report_feature_final_di
-- owner_name: 曹佳程
-- source_json: goal/dp_table_logic/pdm_risk_upstream/pdm_risk_dz_br_horizontal_two_report_rct_mon_two_coalesce.json
