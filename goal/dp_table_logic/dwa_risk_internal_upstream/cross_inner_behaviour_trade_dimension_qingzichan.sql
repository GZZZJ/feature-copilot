...
-- table_name: cross_inner_behaviour_trade_dimension_qingzichan
-- node_id: n_6010041676839124992
-- task_name: dwa_risk_dz_model_final_25_cross_inner_behaviour_df
-- owner_name: 牛莲泽
-- source_json: goal/dp_table_logic/dwa_risk_internal_upstream/cross_inner_behaviour_trade_dimension_qingzichan.json
