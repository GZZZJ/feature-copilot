...
-- table_name: pdm_risk_dh_model_final_telemarket_call_info_features_di
-- node_id: n_5755514561893957632
-- task_name: pdm_risk_dh_model_final_telemarket_call_info_features_di
-- owner_name: 牛莲泽
-- source_json: goal/dp_table_logic/pdm_risk_dh_model_final_telemarket_call_info_features_di.json
-- source_json_sha256: 2140378675ff03bee92642a46fabaa4dc9ffd5aa7800622d9ec0420339e5a6bb
...
----------------------------------
-- drop table if exists ${pdm_risk}.pdm_risk_dh_model_final_telemarket_call_info_sample_di_tmp_1;
-- create table ${pdm_risk}.pdm_risk_dh_model_final_telemarket_call_info_sample_di_tmp_1 as 
with call_sample as (
select  uid
...
-- 02 通话记录底表
----------------------------------
-- drop table if exists ${pdm_risk}.pdm_risk_dh_model_final_telemarket_call_info_tmp_1;
-- create table ${pdm_risk}.pdm_risk_dh_model_final_telemarket_call_info_tmp_1 as
call_info as (
select c.uid,
...
-- 03 增量数据
----------------------------------
-- drop table if exists ${pdm_risk}.pdm_risk_dh_model_final_telemarket_call_info_features_di_tmp_1; 
-- create table ${pdm_risk}.pdm_risk_dh_model_final_telemarket_call_info_features_di_tmp_1 as 
...
select smp_dt.uid, smp_dt.mdl_dte,
 ...
 from call_sample smp_dt--${pdm_risk}.pdm_risk_dh_model_final_telemarket_call_info_sample_di_tmp_1 
 left join call_info atom_dt--${pdm_risk}.pdm_risk_dh_model_final_telemarket_call_info_tmp_1 
...
-- call_max_con_tim_60d,
-- call_avg_con_tim_90d
-- from ${pdm_risk}.pdm_risk_dh_model_final_telemarket_call_info_features_di_tmp_1
-- ;

-- select * from pdm_risk.pdm_risk_dh_model_final_telemarket_call_info_features_di 
-- where ds='20240421' 
-- and uid in ('0001b9cc-efcb-404a-8afe-462bcfa58262','0006ba45-f40c-452e-80b8-69132984da32','001b2992-bb86-4ce2-b1ca-c0a83ae431df','002a62da-972b-4e6d-b2ed-7ba8ee4eca23')
